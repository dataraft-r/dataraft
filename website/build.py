...
for url,p in pages.items():
 ...
 sourcehtml=f'<div class="source-note">Documentation source snapshot · <a href="https://github.com/dataraft-r/{source[0]}/blob/{sha[source[0]]}/{source[1]}">View source at {sha[source[0]][:7]} ↗</a><br>Code examples are documented source examples; they are not executed in this website build.</div>' if source else ''
