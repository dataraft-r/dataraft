...
#' @inherit dataraft.core::dr_add_catalog title description details return params sections
...
#' @inherit dataraft.core::dr_add_contract title description details return params sections
...
#' @inherit dataraft.core::dr_add_product title description details return params sections
...
#' @inherit dataraft.core::dr_add_quality title description details return params sections
...
#' @inherit dataraft.core::dr_add_recipe title description details return params sections
...
#' @inherit dataraft.core::dr_add_source title description details return params sections
...
#' @inherit dataraft.adapters::dr_as_targets title description details return params sections
...
#' @inherit dataraft.core::dr_capabilities title description details return params sections
...
#' @inherit dataraft.catalog::dr_catalog_app title description details return params sections
...
#' @inherit dataraft.catalog::dr_catalog_export title description details return params sections
...
#' @inherit dataraft.catalog::dr_catalog_openlineage title description details return params sections
...
#' @inherit dataraft.catalog::dr_catalog_openmetadata title description details return params sections
...
#' @inherit dataraft.catalog::dr_catalog_openmetadata_dbt title description details return params sections
...
#' @inherit dataraft.core::dr_check_component title description details return params sections
...
#' @inherit dataraft.lake::dr_check_delivery title description details return params sections
...
#' @rdname dr_cleanup
#' @inherit dataraft.lake::dr_cleanup title description details return params sections
...
#' @inherit dataraft.lake::dr_close_lake title description details return params sections
...
#' @rdname dr_collect
#' @inherit dataraft.core::dr_collect title description details return params sections
...
#' @inherit dataraft.metrics::dr_commons_yaml title description details return params sections
...
#' @rdname dr_compare
#' @inherit dataraft.lake::dr_compare title description details return params sections
...
#' @inherit dataraft.core::dr_component_capabilities title description details return params sections
...
#' @rdname dr_contract
#' @inherit dataraft.core::dr_contract title description details return params sections
...
#' @inherit dataraft.core::dr_contract_confirm title description details return params sections
...
#' @inherit dataraft.core::dr_contract_diff title description details return params sections
...
#' @inherit dataraft.core::dr_contract_from title description details return params sections
...
#' @inherit dataraft.core::dr_contract_update title description details return params sections
...
#' @inherit dataraft.adapters::dr_contract_yaml title description details return params sections
...
#' @rdname dr_dbt_build
#' @inherit dataraft.dbt::dr_dbt_build title description details return params sections
...
#' @inherit dataraft.dbt::dr_dbt_contract title description details return params sections
...
#' @rdname dr_dbt_init
#' @inherit dataraft.dbt::dr_dbt_init title description details return params sections
...
#' @inherit dataraft.dbt::dr_dbt_lineage title description details return params sections
...
#' @rdname dr_dbt_model
#' @inherit dataraft.dbt::dr_dbt_model title description details return params sections
...
#' @inherit dataraft.dbt::dr_dbt_project title description details return params sections
...
#' @inherit dataraft.dbt::dr_dbt_publish title description details return params sections
...
#' @inherit dataraft.dbt::dr_dbt_sources title description details return params sections
...
#' @inherit dataraft.dbt::dr_dbt_status title description details return params sections
...
#' @rdname dr_dbt_test
#' @inherit dataraft.dbt::dr_dbt_test title description details return params sections
...
#' @inherit dataraft.core::dr_execute_transform title description details return params sections
...
#' @inherit dataraft.core::dr_execution_config title description details return params sections
...
#' @inherit dataraft.core::dr_expect_quality title description details return params sections
...
#' @inherit dataraft.core::dr_extract_product title description details return params sections
...
#' @inherit dataraft.core::dr_extract_recipe title description details return params sections
...
#' @rdname dr_freshness
#' @inherit dataraft.catalog::dr_freshness title description details return params sections
...
#' @rdname dr_incidents
#' @inherit dataraft.core::dr_incidents title description details return params sections
...
#' @rdname dr_ingest
#' @inherit dataraft.lake::dr_ingest title description details return params sections
...
#' @inherit dataraft.adapters::dr_init_project title description details return params sections
...
#' @rdname dr_inspect
#' @inherit dataraft.core::dr_inspect title description details return params sections
...
#' @inherit dataraft.lake::dr_interrupted title description details return params sections
...
#' @inherit dataraft.lake::dr_lake_config title description details return params sections
...
#' @rdname dr_lineage
#' @inherit dataraft.core::dr_lineage title description details return params sections
...
#' @inherit dataraft.core::dr_lookup_spec title description details return params sections
...
#' @rdname dr_measure
#' @inherit dataraft.metrics::dr_measure title description details return params sections
...
#' @rdname dr_metric
#' @inherit dataraft.metrics::dr_metric title description details return params sections
...
#' @inherit dataraft.metrics::dr_metric_set title description details return params sections
...
#' @rdname dr_model
#' @inherit dataraft.core::dr_model title description details return params sections
...
#' @rdname dr_open_lake
#' @inherit dataraft.lake::dr_open_lake title description details return params sections
...
#' @rdname dr_plan
#' @inherit dataraft.core::dr_plan title description details return params sections
...
#' @inherit dataraft.core::dr_pointblank_checks title description details return params sections
...
#' @inherit dataraft.core::dr_pointblank_report title description details return params sections
...
#' @rdname dr_product
#' @inherit dataraft.core::dr_product title description details return params sections
...
#' @inherit dataraft.core::dr_profile_data title description details return params sections
...
#' @rdname dr_publish
#' @inherit dataraft.core::dr_publish title description details return params sections
...
#' @inherit dataraft.core::dr_publish_metadata title description details return params sections
...
#' @rdname dr_quality
#' @inherit dataraft.core::dr_quality title description details return params sections
...
#' @inherit dataraft.core::dr_quality_counts title description details return params sections
...
#' @inherit dataraft.core::dr_quality_errors title description details return params sections
...
#' @inherit dataraft.core::dr_quality_reference title description details return params sections
...
#' @inherit dataraft.core::dr_quality_report title description details return params sections
...
#' @inherit dataraft.core::dr_quality_rows title description details return params sections
...
#' @inherit dataraft.core::dr_quality_rule title description details return params sections
...
#' @inherit dataraft.lake::dr_read_release title description details return params sections
...
#' @rdname dr_read_run
#' @inherit dataraft.core::dr_read_run title description details return params sections
...
#' @inherit dataraft.core::dr_read_source title description details return params sections
...
#' @rdname dr_recipe
#' @inherit dataraft.core::dr_recipe title description details return params sections
...
#' @rdname dr_recover
#' @inherit dataraft.lake::dr_recover title description details return params sections
...
#' @rdname dr_register
#' @inherit dataraft.lake::dr_register title description details return params sections
...
#' @rdname dr_registry
#' @inherit dataraft.lake::dr_registry title description details return params sections
...
#' @inherit dataraft.lake::dr_registry_duckdb title description details return params sections
...
#' @inherit dataraft.lake::dr_registry_postgres title description details return params sections
...
#' @rdname dr_releases
#' @inherit dataraft.lake::dr_releases title description details return params sections
...
#' @inherit dataraft.core::dr_remove_product title description details return params sections
...
#' @inherit dataraft.core::dr_remove_recipe title description details return params sections
...
#' @inherit dataraft.core::dr_replace_sources title description details return params sections
...
#' @inherit dataraft.metrics::dr_report_read title description details return params sections
...
#' @inherit dataraft.metrics::dr_report_release title description details return params sections
...
#' @inherit dataraft.core::dr_retry_catalogs title description details return params sections
...
#' @rdname dr_run
#' @inherit dataraft.core::dr_run title description details return params sections
...
#' @inherit dataraft.core::dr_run_history title description details return params sections
...
#' @inherit dataraft.core::dr_run_quality title description details return params sections
...
#' @inherit dataraft.core::dr_set_engine title description details return params sections
...
#' @inherit dataraft.core::dr_set_target title description details return params sections
...
#' @inherit dataraft.adapters::dr_source_api title description details return params sections
...
#' @inherit dataraft.adapters::dr_source_database title description details return params sections
...
#' @inherit dataraft.core::dr_source_file title description details return params sections
...
#' @inherit dataraft.adapters::dr_source_parquet title description details return params sections
...
#' @inherit dataraft.adapters::dr_source_pins title description details return params sections
...
#' @inherit dataraft.lake::dr_source_release title description details return params sections
...
#' @inherit dataraft.adapters::dr_sql_transform title description details return params sections
...
#' @rdname dr_status
#' @inherit dataraft.core::dr_status title description details return params sections
...
#' @inherit dataraft.core::dr_step_arrange title description details return params sections
...
#' @inherit dataraft.core::dr_step_lookup title description details return params sections
...
#' @inherit dataraft.core::dr_step_mutate title description details return params sections
...
#' @inherit dataraft.core::dr_step_rename title description details return params sections
...
#' @inherit dataraft.core::dr_step_select title description details return params sections
...
#' @inherit dataraft.core::dr_step_transform title description details return params sections
...
#' @inherit dataraft.lake::dr_storage_local title description details return params sections
...
#' @inherit dataraft.lake::dr_storage_s3 title description details return params sections
...
#' @inherit dataraft.adapters::dr_target_database title description details return params sections
...
#' @inherit dataraft.lake::dr_target_lake title description details return params sections
...
#' @inherit dataraft.adapters::dr_target_parquet title description details return params sections
...
#' @inherit dataraft.adapters::dr_target_pins title description details return params sections
...
#' @rdname dr_tbl
#' @inherit dataraft.lake::dr_tbl title description details return params sections
...
#' @inherit dataraft.dbt::dr_transform_dbt title description details return params sections
...
#' @rdname dr_trial
#' @inherit dataraft.core::dr_trial title description details return params sections
...
#' @inherit dataraft.core::dr_update_product title description details return params sections
...
#' @inherit dataraft.core::dr_update_recipe title description details return params sections
...
#' @rdname dr_validate
#' @inherit dataraft.core::dr_validate title description details return params sections
...
#' @rdname dr_workflow
#' @inherit dataraft.core::dr_workflow title description details return params sections
...
#' @inherit dataraft.lake::dr_write_data title description details return params sections
...
#' @inherit dataraft.core::dr_write_target title description details return params sections
...
#' @inherit dataraft.core::dr_last_failure title description details return params sections
...
#' @inherit dataraft.adapters::dr_target_rds title description details return params sections
...
#' @inherit dataraft.adapters::dr_source_rds title description details return params sections
...
#' @inherit dataraft.core::dr_quarantine_rows title description details return params sections
...
#' @inherit dataraft.core::dr_profile_snapshot title description details return params sections
...
#' @inherit dataraft.core::dr_profile_compare title description details return params sections
...
#' @inherit dataraft.core::dr_column_lineage title description details return params sections
...
#' @inherit dataraft.adapters::dr_contract_odcs title description details return params sections
...
#' @inherit dataraft.adapters::dr_contract_from_odcs title description details return params sections
...
#' @inherit dataraft.adapters::dr_project_yaml title description details return params sections
...
#' @inherit dataraft.adapters::dr_source_iceberg title description details return params sections
...
#' @inherit dataraft.adapters::dr_target_iceberg title description details return params sections
