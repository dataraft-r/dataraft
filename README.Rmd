...
`dr_add_contract()`, `dr_add_quality()`, `dr_recipe()`, `dr_step_mutate()`,
`dr_workflow()`, `dr_add_product()`, `dr_add_recipe()`, `dr_trial()`,
`dr_collect()` and `dr_publish()`. Add specialized components as your workflow grows.

![Products define requirements; recipes define preparation; workflows connect them to a delivery and execution.](man/figures/composition-architecture.svg)
